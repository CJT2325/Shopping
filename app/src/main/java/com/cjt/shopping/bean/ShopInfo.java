...
public class ShopInfo {
    ...
    private int allByTypeLikeSize;
    private int allByTypeSize;
    private int allLikeSize;
    private int allSize;
     ...
     * midCount : 5
     * nextPage : 1
     * pageButtons : [{"sign":"1","signText":"thisclass","text":"1"}]
     * pageSize : 0
     * prePage : 0
     * showCount : 10
     * startPage : 1
     ...
     * details : 好男鞋，华软找
     * discount : 0.9
     * goodImage : {"good":null,"id":45,"shopFile":{"id":118,"url":"/save/9/0feb8317-4c4a-4fdb-81bd-2bc5168d86c0.JPG"}}
     * goodImages : null
     * gradePrivilege : {"cutFive":4,"cutFour":5,"cutOne":8,"cutThree":6,"cutTwo":7,"enoughFive":80,"enoughFour":80,"enoughOne":80,"enoughThree":80,"enoughTwo":80,"good":null,"id":6,"sign":0}
     * id : 38
     * martketPrice : 0
     * name : 精品鞋
     * sellCount : 0
    ...
    public int getAllByTypeLikeSize() {
        return allByTypeLikeSize;
    }

    public void setAllByTypeLikeSize(int allByTypeLikeSize) {
        this.allByTypeLikeSize = allByTypeLikeSize;
    }

    public int getAllByTypeSize() {
        return allByTypeSize;
    }

    public void setAllByTypeSize(int allByTypeSize) {
        this.allByTypeSize = allByTypeSize;
    }

    public int getAllLikeSize() {
        return allLikeSize;
    }

    public void setAllLikeSize(int allLikeSize) {
        this.allLikeSize = allLikeSize;
    }
    ...
    public Object getGoodImage() {
        return goodImage;
    }

    public void setGoodImage(Object goodImage) {
    ...
    public static class CutPageBean {
        private int curPage;
        private int endPage;
        ...
        private List<PageButtonsBean> pageButtons;
        ...
        public List<PageButtonsBean> getPageButtons() {
            return pageButtons;
        }

        public void setPageButtons(List<PageButtonsBean> pageButtons) {
            this.pageButtons = pageButtons;
        }

        public static class PageButtonsBean {
            private String sign;
    ...
    public static class GoodsBean {
         ...
         * good : null
         * id : 45
         * shopFile : {"id":118,"url":"/save/9/0feb8317-4c4a-4fdb-81bd-2bc5168d86c0.JPG"}
         */
        ...
        public int getMartketPrice() {
            return martketPrice;
        }

        public void setMartketPrice(int martketPrice) {
        ...
        public static class GoodImageBean {
            ...
            /**
             * id : 118
             * url : /save/9/0feb8317-4c4a-4fdb-81bd-2bc5168d86c0.JPG
             */
